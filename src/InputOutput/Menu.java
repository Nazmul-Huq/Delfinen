...
public class Menu {
    ...
    private void printTrainerMenuOptions(){
        System.out.println("1. Add swimmer, 2. Add swimmer info, 3. Add swimmer to team, 4. Add Swimming Discipline, 5. Add training result, 6. See best swimmer, 9. Exit app");
    }
